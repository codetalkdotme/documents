...
public class IMCallbackServiceImpl implements IMCallbackService {
	...
	// 登录消息响应
	public static final String CMD_SC_LOGIN = "|^|^hca/api/im/sc/login^|^|";
	
	// 消息上行响应
	public static final String CMD_SC_MSGUP = "|^|^hca/api/im/sc/msgup^|^|";
	
	// 消息下行
	public static final String CMD_SC_MSGDOWN = "|^|^hca/api/im/sc/msgdown^|^|";
	
	// 消息数量响应
	public static final String CMD_SC_MSGCOUNT = "|^|^hca/api/im/sc/getmsgcount^|^|";
	
	// 消息列表响应
	public static final String CMD_SC_MSGLIST = "|^|^hca/api/im/sc/getmsg^|^|";
